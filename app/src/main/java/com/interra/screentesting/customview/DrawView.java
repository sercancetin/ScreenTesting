package com.interra.screentesting.customview;
...
import com.interra.screentesting.model.FingerPath;
...
public class DrawView extends View {
    ...
    public void init(DisplayMetrics metrics, int mHeight){
        int height = metrics.heightPixels+mHeight;
        int width = metrics.widthPixels;
